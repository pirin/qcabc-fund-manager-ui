...
export type GetPortfolioUpdatesQuery = { portfolioUpdates: Array<Pick<PortfolioUpdate, 'blockTimestamp' | 'id' | 'newPortfolioValue' | 'newSharePrice' | 'timestamp' | 'transactionHash'>> };
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetPortfolioUpdates(variables?: GetPortfolioUpdatesQueryVariables, options?: C): Promise<GetPortfolioUpdatesQuery> {
      return requester<GetPortfolioUpdatesQuery, GetPortfolioUpdatesQueryVariables>(GetPortfolioUpdatesDocument, variables, options) as Promise<GetPortfolioUpdatesQuery>;
    },
